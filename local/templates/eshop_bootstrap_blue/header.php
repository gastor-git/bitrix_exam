...
CJSCore::Init(array("fx", 'ajax', 'popup', 'viewer'));
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                    <div class="bx-logo">
                        ...
                        <a class="bx-logo-block hidden-lg hidden-md hidden-sm text-center"
                           href="<?= htmlspecialcharsbx(SITE_DIR) ?>">
                            <? $APPLICATION->IncludeComponent(
                                "bitrix:main.include",
                                "",
                                array(
                        ...
                        <? $frame->begin(); ?>
                            <? if ($USER->IsAuthorized()) { ?>
                                <div class="slogan">Слоган для авторизованных</div>
                            <? } else { ?>
                                <div class="slogan">Слоган для неавторизованных</div>
                            <? } ?>
                        <? $frame->beginStub(); ?>
                            <div class="slogan">Заглушка</div>
                        <? $frame->end(); ?>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
